...
import { DeleteCourseType, setDeleteCourseTypeModalOpen } from "../../Redux/CourseSlice";
        ...
        <div className="bg-black/15 w-full h-full absolute top-0 flex justify-center items-center p-2 z-9999">
            <div className="bg-white p-2 md:p-4 rounded-md drop-shadow-2xl w-full sm:w-[400px]">
                ...
                <div className="flex gap-5 px-5">
                    <button onClick={() => {
                        dispatch(DeleteCourseType());
                        dispatch(setDeleteCourseTypeModalOpen())
                    }} className="bg-[brown] text-white px-4 py-2 rounded-md drop-shadow hover:bg-[brown]/85 active:bg-[brown] active:drop-shadow-none text-sm">
                        Yes
                    </button>
